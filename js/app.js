(() => {
    ...
    class FullPage {
        ...
        styleCards() {
            for (let index = 0; index < this.sections.length; index++) {
                const section = this.sections[index];
                if (index >= this.activeSectionId) section.style.transform = "translate3D(0,0,0) rotatez(0) skew(0, 0)"; else if (index < this.activeSectionId) section.style.transform = "translate3D(-15%,-150%,0) rotatez(-12deg)  skew(25deg, 10deg)";
            }
        }
        styleFade() {
            for (let index = 0; index < this.sections.length; index++) {
